...
import { Download, Sparkles, Video, Image as ImageIcon, Zap, Shield, Mail, ArrowLeft, TrendingUp, Globe, Book, ShoppingBag, Coins } from 'lucide-react'
...
export default function Manual() {
  ...
  return (
    <div className="app-container" style={{ background: 'var(--bg-main)' }}>
      ...
      {/* Header */}
      <header className="header no-print" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '20px 40px' }}>
          ...
          <section style={{ marginBottom: '2.5rem' }}>
            ...
            <div style={{ color: 'var(--text-muted)', lineHeight: '1.6', fontSize: '0.95rem', display: 'flex', flexDirection: 'column', gap: '10px' }}>
              ...
              <ul style={{ paddingLeft: '20px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                ...
                <li><strong>Reale KI-Generierung:</strong> Gib deine Nische oder dein Produkt ein und klicke auf <i>„Exklusiven Prompt generieren“</i>. Unser System nutzt modernste KI (Meta Llama-3-70b), um in Sekundenschnelle einen maßgeschneiderten, hochqualitativen englischen Prompt sowie eine deutsche Übersetzung für dich zu erstellen (Kosten: 1 Credit).</li>
